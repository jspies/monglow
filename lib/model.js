var MonglowModel = (function() {
  ...
  MonglowModel.find = function(options, callback) {
    if (typeof(options) == "function") {
      callback = options;
      options = {};
    }
    var self = this;
    var req = this.client.collection(this.model_name).find(options);
  ...
  MonglowModel.findOne = function(options, callback) {
    ...
    var self = this;
    var request = this.client.collection(this.model_name).findOne(options);
    // WIP
  }
